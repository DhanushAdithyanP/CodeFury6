...
class _JournalScreenState extends State<JournalScreen> {
    ...
    setState(() {
      filteredNotes = sampleNotes
          .where((journal) =>
              ...
              journal.title.toLowerCase().contains(searchText.toLowerCase()))
          .toList();
    });
  }
  ...
  void deleteNote(int index) {
    setState(() {
      Journal journal = filteredNotes[index];
      sampleNotes.remove(journal);
                        ...
                        final result = await Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (BuildContext context) =>
                                EditScreen(journal: filteredNotes[index]),
                          ),
                        );
                        if (result != null) {
                          setState(() {
